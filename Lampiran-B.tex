...
Bagian ini menyajikan satu contoh penelusuran implementasi untuk menunjukkan bagaimana nilai tiap atribut menghasilkan AffinityScore akhir, dengan data masukan pada Tabel~\ref{tab:b-contoh-input} dan hasil perhitungannya pada Tabel~\ref{tab:b-contoh-skor}. Contoh ini bersifat ilustratif dan digunakan untuk memperjelas alur implementasi, bukan sebagai hasil evaluasi akhir sistem.
...
\midrule
Preferensi peran     & \emph{Contributor/Executor}        & \emph{Leader/Coordinator}, \emph{Contributor/Executor} \\
\end{longtable}
