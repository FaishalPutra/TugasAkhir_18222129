...
\item Mengembangkan mekanisme \emph{Affinity-Based Matching} yang dapat menghitung dan menyajikan tingkat kecocokan mahasiswa dengan kegiatan kolaboratif berdasarkan atribut profil yang relevan, meliputi minat, keterampilan, pengalaman, dan preferensi gaya kerja.
\end{enumerate}
...
\begin{enumerate}
\item Bab I Pendahuluan: membahas latar belakang permasalahan yang melatarbelakangi pengembangan modul rekomendasi \emph{People-to-People}, rumusan masalah, tujuan penelitian, batasan masalah, metodologi pengerjaan, dan sistematika penulisan laporan.
...
\item Bab IV Perancangan: membahas perancangan sistem secara menyeluruh, mencakup deskripsi \emph{high-level} sistem, dekomposisi dan pembagian modul, perancangan model sistem modul \emph{People-to-People} dalam bentuk diagram UML, perancangan arsitektur, perancangan basis data, desain antarmuka, serta perancangan algoritma \emph{Affinity-Based Matching}.
\item Bab V Implementasi: membahas proses implementasi modul \emph{People-to-People} berdasarkan hasil perancangan, mencakup teknologi yang digunakan, lingkungan pengembangan, dan hasil implementasi setiap fitur.
