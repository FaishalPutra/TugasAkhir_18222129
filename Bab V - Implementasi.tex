...
\begin{longtable}{>{\centering\arraybackslash}m{1cm} >{\centering\arraybackslash}m{5cm} >{\raggedright\arraybackslash}m{\dimexpr\linewidth-6cm-6\tabcolsep\relax}}
  ...
  \bottomrule
  \endlastfoot
    L01 & \includegraphics[width=4.5cm]{images/Layar/L1} & Formulir pengisian data akun mahasiswa baru \\
    \midrule
    L02 & \includegraphics[width=4.5cm]{images/Layar/L2} & Formulir otentikasi menggunakan \emph{email} dan kata sandi \\
    \midrule
    L03 & \includegraphics[width=4.5cm]{images/Layar/L3} & Halaman pengisian dan pembaruan atribut profil kolaboratif (\emph{skill}, pengalaman, minat, gaya kerja, preferensi peran) yang menjadi masukan perhitungan \emph{AffinityScore} \\
    \midrule
    L04 & \includegraphics[width=4.5cm]{images/Layar/L4} & Menampilkan data profil pengguna serta menyediakan aksi keluar akun dan akses ke halaman pengelolaan profil \\
    \midrule
    L05 & \includegraphics[width=4.5cm]{images/Layar/L5} & Menampilkan \emph{feed} kegiatan kolaboratif terurut menurun berdasarkan perhitungan \emph{AffinityScore}, dilengkapi \emph{badge} tingkat kecocokan \\
    \midrule
    L06 & \includegraphics[width=4.5cm]{images/Layar/L6} & Menampilkan detail kegiatan kolaboratif serta menjadi titik akses untuk mengajukan pendaftaran \\
    \midrule
    L07 & \includegraphics[width=4.5cm]{images/Layar/L7} & Formulir pembuatan kegiatan kolaboratif baru berisi judul, deskripsi, kebutuhan \emph{role} dan \emph{skill}, kuota, serta \emph{timeline} kegiatan \\
    \midrule
    L08 & \includegraphics[width=4.5cm]{images/Layar/L8} & Menampilkan daftar pendaftar suatu kegiatan beserta \emph{role} yang dilamar, \emph{AffinityScore}, dan status pendaftaran \\
    \midrule
    L09 & \includegraphics[width=4.5cm]{images/Layar/L9} & Antarmuka bagi pembuat kegiatan untuk meninjau, menerima, atau menolak pendaftar \\
\end{longtable}
