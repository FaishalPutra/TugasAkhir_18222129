...
% AWAL DOKUMEN
% ==========================================
\raggedbottom % mencegah regangan vertikal paksa antar paragraf (default book = flushbottom)
\ExecuteBibliographyOptions{dashed=false} % selalu tampilkan nama penulis lengkap, tidak diganti garis
\begin{document}
